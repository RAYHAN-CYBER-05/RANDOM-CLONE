#Sc Make By Asraful Islam RAYHAN
#Sc Gift By RAYHAN
...
\_| \_\__,_|\__, |_| |_|\__,_|_| |_|
            ...
            |___/                               
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                     
  Tools Create {+} RAYHAN AHMED
  Github Account {+} RAYHAN-CYBER-05
  Fb Group  Name {+} BARISHAL CYBER GANG BCG                                                                                  
  Tools Status {+} FREE
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
""")
...
def fuck():
    ...
    print(' [✓] OK Ids saved as RAYHAN-OK.txt')
    print(' [✓] CP Id Save as RAYHAN-CP.txt')
    print('-------------------')
def RAYHAN(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[RAYHAN]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
